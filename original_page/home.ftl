...
<div class="list-group" >
	...
	<a href="/demo/person/mytest" class="list-group-item" >
	...
	<a href="/demo/person/user" class="list-group-item">
		<h4 class="list-group-item-heading">
	...
	<a href="/demo/person/money" class="list-group-item">
		<h4 class="list-group-item-heading">
	...
	<a href="/demo/person/worktime" class="list-group-item">
		<h4 class="list-group-item-heading">&nbsp;&nbsp;工时信息
		<img src="../images/zuzhijiagou.png" class="img-responsive pull-left png img-circle"  style="margin-top:-4px;"/>
		</h4>
		<p class="list-group-item-text">&nbsp;&nbsp;&nbsp;我的详细工时信息</p>
	</a>
	<a href="/demo/person/kaoqin" class="list-group-item">
                    ...
                    <div class="container" align="center">
                        ...
                        <ul class="nav nav-tabs nav-tabs-justified">
                            <div class="row" align="center">
                                <div class="col-md-4 col-sm-4 col-xs-4" align="center"><li><a href="#"><img src="../images/index_10.png" class="img-responsive png1 img-circle" /></a></li></div>
                                <div class="col-md-4 col-sm-4 col-xs-4" align="center"><li><a href="#"><img src="../images/ry.png" class="img-responsive png1 img-circle" /></a></li></div>
                                <div class="col-md-4 col-sm-4 col-xs-4" align="center"><li><a href="#"><img src="../images/sy.png" class="img-responsive png1 img-circle" /></a></li></div>
                            </div>
                        </ul>
                    </div>
                </nav>
